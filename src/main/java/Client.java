...
// Constructor
  public Client(String _name, String _phone, String _email, Date _next_appt, String _img_url) {
    name = _name;
    phone = _phone;
    email = _email;
...
//     String sql = "SELECT name, phone, email, next_appt, img_url, id, stylistId FROM clients;";
